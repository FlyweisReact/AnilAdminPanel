  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/login",
        {
          email,
          password,
        }
            ...
            >
              {loading ? (
                <div style={{ display: "block", margin: "auto" }}>
                  <Oval height={30} secondaryColor="black" color="black" style={{  display: "block", margin: "auto"}} />
                </div>
              ) : (
                <>
