          ...
          {nav.map((nav) => {
            return (
              ...
              >
                <span
                className={location
                .pathname === nav.link ? "active flex my-3 items-center cursor-pointer text-gray-900    tracking-wider p-2 rounded-sm " : "flex my-3 items-center cursor-pointer text-gray-900    tracking-wider p-2 rounded-sm active"
              }
                  // className=" "
                  style={{ color: "#FFF" }} 
                >
