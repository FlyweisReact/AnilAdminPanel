...
const EAdminDelivery = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post(" https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/coupons" , {
          couponCode , 
          expirationDate , 
          activationDate , 
          discount , 
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" required onChange={(e) => setCouponCode(e.tar)} />
            </Form.Group>
            <Form.Group className="mb-3">
