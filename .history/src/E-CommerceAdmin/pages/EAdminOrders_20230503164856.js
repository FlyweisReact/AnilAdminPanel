...
const EAdminOrders = () => {
  ...
  function EditStatus(props) {
    ...
    const paidHandler = async(e) => {
      e.preventDefault()
      try {
        const { data } = await axios.post(` https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/orders/${id}` , {
          isPaid
        })
    ...
    const deliveryHandler = async (e) => {
      e.preventDefault()
      try {
        const { data } = await axios.put(` https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/orders/${id}` , {
          isDelivered
        })
        toast.success(data.message)
      }catch(e) { 
    ...
    return (
      ...
      >
        ...
        <Form onSubmit={paidHandler}>
            <Form.Select aria-label="Default select example" className="mb-3" onChange={(e) => setIsPaid(e.target.value)} >
          ...
          <Form onSubmit={deliveryHandler}>
            <Form.Select aria-label="Default select example" className="mb-3"  onChange={(e) => setIsDelivered(e.target.value)}>
