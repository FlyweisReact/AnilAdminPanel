...
const EAdmin = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post(" https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/brands" , {
          brandIcon , brandName , brandStatus
        })
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="file" required onChange={(e) => setBrandName(e.target.files[0])} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Email</Form.Label>
              <Form.Control type="email" required onChange={(e) => setBrandName(e.target.value)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Phone Number</Form.Label>
              <Form.Control type="number" required  onChange={(e) => setBrandName(e.target.value)}/>
            </Form.Group>
