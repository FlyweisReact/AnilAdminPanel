...
const EProduct = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const [ discountPercent , setDisccountPercentage ] = useState("")
    ...
    const postHandler  = async (e) => {
      ...
      try {
        const { data } = await axios.post(" https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/products" , fd)
        ...
        <Modal.Body>
          <Form onSubmit={edit ? "" : postHandler}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="file" required multiple onChange={(e) => setImage(e.ta)} />
            </Form.Group>
