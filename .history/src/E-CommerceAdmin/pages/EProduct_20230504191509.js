...
import { Table, Modal, Form, Button, Badge, Alert } from "react-bootstrap";
      ...
      <section className="sectionCont">
        ...
        <div className="overFlowCont">
          ...
          <div className="pagination">
            <button onClick={() => Prev()} className='prevBtn' >   <i className="fa-solid fa-backward"></i> Prev</button>
            {currentPage2 === 1 ? (
              ""
            ) : (
            ...
            {currentPage2 === pages2?.length ? (
              ...
              <button onClick={() => Next()} className='nextBtn'>Next <i className="fa-sharp fa-solid fa-forward"></i></button>
            )}
          </div>
        </div>
            </>
