    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          " https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/festival-offers", fd
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://xw9mf13nwl.execute-api.ap-south-1.amazonaws.com/dev/api/v1/festival-offers/${id}`
      );
      toast.success(data.message);
      fetchData();
    } catch (e) {
