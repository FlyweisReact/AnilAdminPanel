...
const Login = () => {
  ...
  const submitHandler = async (e) => {
    ...
    setLoading(true);
    try {
      navigate("/E-Commerce/vendor/dashboard");
      toast.success("Welcome E-Commerce Vendor ");
      setLoading(false);
    } catch (err) {
    ...
    <>
      ...
      >
        <form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 ">
          <p
            className="text-3xl"
            style={{ color: "#576cbc", fontWeight: "bold"  , textTransform : 'uppercase'}}
          >
            {" "}
